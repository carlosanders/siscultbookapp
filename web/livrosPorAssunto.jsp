...
<div id="catalogoLivro">
    ...
    <div id="path">
        <ul>
            ...
            <li class="first">${titulo}<font color="#FF0000">${assuntoProcurado} - ${totalLivroDoAssunto} produto(s) encontrado(s)</font></li>
    ...
    <center>
        <strong style="color:#F00; text-align:center">O Sistema n&atilde;o encontrou nenhuma obra do autor: ${assuntoProcurado}</strong>
    </center>
    <div class="push20"></div>
    <%                }
    %>
