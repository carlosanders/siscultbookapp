...
<div id="cadastros">
    ...
    --%>
    <form name="form" id="form" class="cmxform" action="SisCultbookController" method="post" >
        <input type='hidden' name='cmd' value="cadastrarClientePainel" />
        ...
        <div>
            <button type="submit" id="submit-go" tabindex="16"><p style="margin-top:-4px;">Salvar</p></button>
        </div>
    </form>
