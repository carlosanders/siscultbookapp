...
<div id="cadastros">
    ...
    <form name="form" id="form" action="SisCultbookController" method="post" >
        <input type='hidden' name='cmd' value="atualizarFuncionario" />
        <input type='hidden' name='codigo' value="${param.codigo}" />
        <fieldset class="EditarFuncionario">
        Os campos com (<font color="#ff0000">*</font>) s&atilde;o de preenchimento obrigat&oacute;rio:<br /><br />
            ...
            <span style="font-size:11px; margin-left:150px;">ex: 12/12/1900</span>        
            <div>
                <label for="dataAdmissao"><font color="#FF0000">*</font> Data Admiss&atilde;o</label> 
                <input id="dataAdmissao" name="dataAdmissao" value="${funcionarioDataAdmissao}" type="text" class="{validate:{required:true,dateBR:true}}"  tabindex="5">
            </div>
            <div>
            ...
            <div>
                <label for="cidadeContato"><font color="#FF0000">*</font> Rua</label> <input id="rua" name="rua" value="${funcionario.endereco.rua}" type="text" class="{validate:{required:true,minlength:3}}" tabindex="9">
            </div>
            <div>
                <label for="cidadeContato"><font color="#FF0000">*</font> Bairro</label> <input id="bairro" name="bairro" value="${funcionario.endereco.bairro}" type="text" class="{validate:{required:true,minlength:3}}" tabindex="10">
            </div>
            <div>
                <label for="cidadeContato"><font color="#FF0000">*</font> Cidade</label> <input id="cidade" name="cidade" value="${funcionario.endereco.cidade}" type="text" class="{validate:{required:true,minlength:3}}" tabindex="11">
            </div>
            <div>
                <label for="cepContato">CEP</label> <input id="cep" name="cep" value="${funcionario.endereco.cep}" type="text" class="{validate:{required:true}}" tabindex="12">
            </div>
        ...
        <fieldset class="login">
            ...
            <div>
                <label for="Senha"><font color="#FF0000">*</font> Senha</label> <input id="senha" name="senha" value="${funcionario.loginFuncionario.senha}" type="text" class="{validate:{required:true,minlength:6}}" tabindex="15">
            </div>
            <div>
        ...
        <div>
            ...
            <button type="submit" id="submit-go" tabindex="19"><p style="margin-top:-4px;">Atualizar</p></button>
        </div>
    </form>
</div>