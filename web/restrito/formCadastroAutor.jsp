...
<div id="cadastros">
    ...
    <form name="form" id="form" action="SisCultbookController" method="post" >
        <input type='hidden' name='cmd' value="cadastrarAutor" />
        ...
        Os campos com (<font color="#ff0000">*</font>) s&atilde;o de preenchimento obrigat&oacute;rio:<br /><br />
            ...
            <div>
                <label for="dataNascimento"><font color="#FF0000">*</font> Data Nascimento</label> <input id="dataNascimento" name="dataNascimento" value="${autorDataNascimento}" type="text" class="{validate:{required:true,dateBR:true}}" tabindex="2">
            </div>
            <span style="font-size:11px; margin-left:150px;">Obs. s&oacute; n&uacute;meros</span>
            <div>
                <label for="cpf">CPF</label> <input id="cpf" name="cpf" value="${autor.cpf}" type="text" class="{validate:{required:true,verificaCPF:true}}" tabindex="3">
            </div>
            <div class="radio">
                <fieldset>
            ...
            <div>
                <label for="rua"><font color="#FF0000">*</font> Rua</label> <input id="rua" name="rua" value="${autor.endereco.rua}" type="text" class="{validate:{required:true,minlength:3}}" tabindex="6">
            </div>
            <div>
                <label for="bairro"><font color="#FF0000">*</font> Bairro</label> <input id="bairro" name="bairro" value="${autor.endereco.bairro}" type="text" class="{validate:{required:true,minlength:3}}" tabindex="7">
            </div>
            <div>
                <label for="cidade"><font color="#FF0000">*</font> Cidade</label> <input id="cidade" name="cidade" value="${autor.endereco.cidade}" type="text" class="{validate:{required:true,minlength:3}}" tabindex="8">
            </div>
            <span style="font-size:11px; margin-left:150px;">Obs. s&oacute; n&uacute;meros</span>
            <div>
                <label for="cep"><font color="#FF0000">*</font> CEP</label> 
            ...
            <div class="radio">
              <fieldset>
                    ...
                    <% } else {%>
                    <div class="fabrik_subelement" style="float: left; width: 98%;margin:0.2em 0 0 0;">
                        <input id="statusAutor" name="statusAutor" value="<%=status.name()%>" type="radio" class="{validate:{required:true}}" tabindex="13">
                        <label for="statusAutor"><%=status.name()%>.</label>
                    </div>
                    <% }%>
                    <% }%>
        ...
        <div>
            ...
            <button type="submit" id="submit-go" tabindex="14"><p style="margin-top:-4px;">Salvar</p></button>
        </div>
    </form>
</div>