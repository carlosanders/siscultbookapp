...
<div id="cadastros">
    ...
    <form name="form" id="form" action="SisCultbookController" method="post" >
        <input type='hidden' name='cmd' value="cadastrarCliente" />
      ...
      <div>
                <label for="telefoneContato"><span id="obrigatorio">*</span> Telefone</label> <input id="telefoneContato" name="telefoneContato" value="${cliente.telefone}" type="text" class="{validate:{required:true}}" tabindex="5">
            </div>
            <div>
                <label for="emailContato"><span id="obrigatorio">*</span> E-mail</label> <input id="emailContato" name="emailContato" value="${cliente.email}" type="text" class="{validate:{required:true,email:true}}" tabindex="6">
            </div>
            <div>
                <label for="rua"><span id="obrigatorio">*</span> Rua</label> <input id="rua" name="rua" value="${cliente.endereco.rua}" type="text" class="{validate:{required:true,minlength:3}}" tabindex="7">
            </div>
            <div>
                <label for="bairro"><span id="obrigatorio">*</span> Bairro</label> <input id="bairro" name="bairro" value="${cliente.endereco.bairro}" type="text" class="{validate:{required:true,minlength:3}}" tabindex="8">
            </div>
            <div>
                <label for="cidade"><span id="obrigatorio">*</span> Cidade</label> <input id="cidade" name="cidade" value="${cliente.endereco.cidade}" type="text" class="{validate:{required:true,minlength:3}}" tabindex="9">
            </div>
            <span style="font-size:11px; margin-left:150px;">Obs. s&oacute; n&uacute;meros</span>
          <div>
            ...
            <div class="radio">
                <fieldset>
                    ...
                    <div class="fabrik_subelement" style="float: left; width: 98%; margin:0.2em 0 0 0;">
                        ...
                        <label for="estadoCivil"><%=situacao.name()%>.</label>
                    </div>
                    <% } else {%>
                    <div class="fabrik_subelement" style="float: left; width: 98%; margin:0.2em 0 0 0;">
        ...
        <fieldset class="login">
			...
			<span style="font-size:11px; margin-left:150px;">Obs. s&oacute; n&uacute;meros</span>
            <div>
                <label for="cpf"><span id="obrigatorio">*</span> CPF</label> <input id="cpf" name="cpf" value="${cliente.cpf}" type="text" class="{validate:{required:true,verificaCPF:true}}" tabindex="14">
            </div>

            <div>
                <label for="senha"><span id="obrigatorio">*</span> Senha</label> <input id="senha" name="senha" value="${cliente.loginCliente.senha}" type="text" class="{validate:{required:true,minlength:6}}" tabindex="15">
            </div>

            <div>
                <label for="nivelAcesso"><span id="obrigatorio">*</span> Nível de Acesso</label>
            ...
            <div class="radio">
                <fieldset>
                    ...
                    <div class="fabrik_subelement" style="float: left; width: 98%;margin:0.2em 0 0 0;">
                        ...
                        <label for="statusUsuario"><%=status.name()%>.</label>
                    </div>
                    <% } else {%>
                    <div class="fabrik_subelement" style="float: left; width: 98%;margin:0.2em 0 0 0;">
