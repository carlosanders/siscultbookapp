...
<%----%>   
 <script type="text/javascript">
	$(document).ready(function(){
		$("#telefone_ent").mask("(99) 9999-9999");
...
<div id="catalogoLivro">
    ...
    <div id="sobre" >
        ...
        <span class="shopDesc">&nbsp;</span>

        <div class="push20"></div>

        <form name="entrega" action="SisCultbookController" method="post" onsubmit="return vali(this);">
            <input type='hidden' name='cmd' value="gravarPedido" />
            <!-- Flag: False-->
            ...
            <div id="dados">
                <div id="dadosUsuario">
                    ...
                    <div class="push5"></div>
                    <a href="SisCultbookController?cmd=dadosCliente&amp;codigo=${codigoUsuario}" class="remove">» Alterar Cadastro</a>
			...
			Clique ao lado, caso o endereço para seja o mesmo do cadastro
                    ...
                    <p class="cart2"><b><span id="obrigatorio">*</span> CEP:</b><span style="font-size:11px; margin-left:5px;">Obs. s&oacute; n&uacute;meros</span><br>
                        <input id="cep_ent" name="cep_ent" maxlength="30" class="campo" size="35" value="" />
                        <input name="cep" value="<%=Utilitario.formatarString(cliente.getEndereco().getCep(), "#####-###")%>" type="hidden" /><br>

                    </p>
					
                    <p class="cart2"><b>Telefone:</b><span style="font-size:11px; margin-left:5px;">Obs. s&oacute; n&uacute;meros</span><br>
                        <input id="telefone_ent" name="telefone_ent" maxlength="30" class="campo" size="35" value="" />
                        <input name="telefone" value="<%=Utilitario.formatarString(cliente.getTelefone(), "(##) ####-####")%>" type="hidden" /><br>
            ...
            <div class="push15"></div>
            <div id="formaFrete">
                <span class="productDesc"><font color="#ff0000">*</font> Forma de Frete</span>
                <div class="push5"></div>
                <p class="cart">
            ...
            <div id="formaPgto">
                <span class="productDesc"><font color="#ff0000">*</font> Formas de Pagamento</span>
                <div class="push5"></div>
                <p class="cart2">
                    <input id="radio1" onclick="document.getElementById('cartao').style.display='block';" value="cartao" name="fpagamento" type="radio">
                ...
                <div id="cartao">
                    <p class="cart2"><font color="#ff0000">*</font> Cartão de Crédito &nbsp;
                    ...
                    <p class="cart2"><font color="#ff0000">*</font> Parcelamento
                        <select name="parcelas">
                            <option selected="selected" value="">  Escolha aqui  </option>
                            <%
                                        if (request.getAttribute("valorTotalPedidoSemFormatacao") != null) {                                            
                                            for (int i = 1; i <= 6; i++) {
                                                double parcela = (Double) request.getAttribute("valorTotalPedidoSemFormatacao") / i;
                            %>
                            <option value="<%=i%>"><%=i%>x de <%=Utilitario.formatarParaMonetario(parcela)%></option>
                            <%
                                            }
                                        }
                            %>
                    ...
                    <div class="push5"></div>
                    <p class="cart2"><font color="#ff0000">*</font> Nome do Titular&nbsp;
                        <input name="nome_cartao" maxlength="20" class="campo">
                    </p>

                    <div class="push5"></div>
                    <p class="cart2"><font color="#ff0000">*</font> Número do Cartão
                        <input name="num_cartao" class="campo" maxlength="22">
                    </p>

                    <div class="push5"></div>

                    <p class="cart2"><font color="#ff0000">*</font> Código Verificador
                        <input name="cod_verificador" class="campo" size="4" maxlength="4"><img src="images/cart2.gif" width="86" height="53">
                    </p>

                    <div class="push5"></div>
                    <p class="cart2"><font color="#ff0000">*</font> Data de Validade
                ...
                <p class="cart2">
                    <input id="radio1" onclick="document.getElementById('cartao').style.display='none';" value="boleto" name="fpagamento" type="radio"> 
                    <b>Boleto Bancário</b>
                </p>
            ...
            <div id="dadosFinalizando">
                <center>
                    ...
                    <div style="float: right;">
                        <input src="images/bt_next.png" border="0" type="image" />
                    </div>
                </center>    
            </div>
        </form>
