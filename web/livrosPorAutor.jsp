...
<div id="catalogoLivro">
    ...
    <div id="path">
        <ul>
            ...
            <li class="first">${titulo}<font color="#FF0000">${autorProcurado.sobrenome} - ${totalLivroDoAutor} produto(s) encontrado(s)</font></li>
    ...
    <center>
        <strong style="color:#F00; text-align:center">O Sistema n&atilde;o encontrou nenhuma obra do autor: ${autorProcurado.sobrenome}</strong>
    </center>
    <div class="push20"></div>
    <%                }
    %>
