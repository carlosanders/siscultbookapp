 ...
 * @author Carlos
 */
public class AtualizarFuncionario implements InterfaceCommand {

    private InterfaceFuncionarioDAO funcionarioDAO;
    private NivelDeAcessoDAO acessoDAO;

    public AtualizarFuncionario(InterfaceFuncionarioDAO funcionarioDAO, NivelDeAcessoDAO acessoDAO) {
        super();
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            System.out.println("dados do form - " + dataAdmissao);
            ...
            Matcher mDataDemissao = pData.matcher(dataDemissao);
            if (dataDemissao.equals("") || dataDemissao == null || !mDataDemissao.find()
                    || Utilitario.verificaData(dataDemissao) == null) {
                //mensagem = mensagem + "Digite uma data válida, para o campo data de demissão.<br />";
                funcionario.setDataDemissao(null);
                retorno = false;
            } else {
                funcionario.setDataDemissao(Utilitario.verificaData(dataDemissao));
            }
            ...
            /*
            String dataUltimoAcesso = request.getParameter("dataUltimoAcesso");
            Matcher mDataUltimoAcessoo = pData.matcher(dataUltimoAcesso);
            if (dataUltimoAcesso.equals("") || dataUltimoAcesso == null || !mDataUltimoAcessoo.find()
            || Utilitario.verificaData(dataUltimoAcesso) == null) {
            mensagem = mensagem + "Digite uma data válida, para o campo data do último acesso.<br />";
            retorno = true;
            }
             */
             ...
             */
            //seto os valores do form no bean Funcionario
            funcionario.setCodigoFuncionario(Integer.parseInt(request.getParameter("codigo")));
