 ...
 * @author Carlos
 */
public class ExibirLivrosPedidos implements InterfaceCommand {

    private InterfacePool pool;

    public ExibirLivrosPedidos(InterfacePool pool) {
        super();
        this.pool = pool;
    }
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            String pathJasper = request.getAttribute("dirRelatorios") + "/totalLivrosPorCliente.jasper";
            String path = request.getAttribute("dirServleContext") + "/WEB-INF/classes/br/com/siscultbook/relatorios/totalLivrosPorCliente.jasper";
