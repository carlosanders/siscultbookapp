...
public class CadastrarCliente implements InterfaceCommand {
    ...
    public CadastrarCliente(InterfaceClienteDAO clienteDAO, NivelDeAcessoDAO acessoDAO) {
        super();
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (nomeCompleto.equals("") || nomeCompleto == null || nomeCompleto.length() < 3) {
                mensagem = mensagem + "Digite seu nome completo, deve ser maior 3 caracteres.<br />";
                retorno = true;
            } else {
            ...
            if (valorNivelAcesso == null || valorNivelAcesso.equals("")) {
                mensagem = mensagem + "Selecione o Nível de acesso para o funcionário.<br />";
                retorno = true;
            } else {
