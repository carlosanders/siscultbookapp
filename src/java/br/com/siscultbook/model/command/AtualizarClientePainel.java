 ...
 * @author com1dn-711
 */
public class AtualizarClientePainel implements InterfaceCommand {

    private InterfaceClienteDAO clienteDAO;
    private NivelDeAcessoDAO acessoDAO;

    public AtualizarClientePainel(InterfaceClienteDAO clienteDAO, NivelDeAcessoDAO acessoDAO) {
        super();
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        request.setAttribute("titulo", "Editando Meus Dados");
        ...
        try {
            ...
            if (codigo == null || codigo.equals("")) {
                request.setAttribute("erro", "Código incorreto!");
                return "SisCultbookController?cmd=dadosCliente";
            }
            ...
            if (retorno) {
                ...
                cliente.setCodigoCliente(Integer.parseInt(codigo));
                ...
                request.setAttribute("mensagem", "(" + cliente.getNomeCompleto() + ") dados atualizados com sucesso!");
                request.setAttribute("clienteDataNascimento", Utilitario.DataFormatada(cliente.getDataNascimento()));
                request.setAttribute("clienteDataCadastro", Utilitario.DataFormatada(cliente.getDesde()));
                request.setAttribute("clienteEstadoCivil", cliente.getEstadoCivil());
